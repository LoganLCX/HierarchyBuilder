...
export class DataZoomRenderer {
    ...
    _initAttrs(props) {
        ...
        isFunction(previewPointsY1) && (this._previewPointsY1 = previewPointsY1), this._getState = props.getState, 
        this._getLayoutAttrFromConfig = props.getLayoutAttrFromConfig, this._getContainer = props.getContainer;
    }
    constructor(props) {
