...
class LineAxis extends base_1.AxisBase {
    constructor(attributes, options) {
        ...
        void 0 === attributes.labelHoverOnAxis.space)) {
            const {padding: padding = 2} = attributes.labelHoverOnAxis, parsedPadding = (0, 
            vutils_1.normalizePadding)(padding), toDiffPadding = "bottom" === attributes.orient ? parsedPadding[0] : "left" === attributes.orient ? parsedPadding[1] : "top" === attributes.orient ? parsedPadding[2] : parsedPadding[3], space = (null !== (_a = attributes.label.space) && void 0 !== _a ? _a : LineAxis.defaultAttributes.label.space) - toDiffPadding;
    ...
    renderLabelHoverOnAxis() {
        const hoverOnLabelAttributes = this.getLabelHoverOnAxisAttribute(), hoverOnLabel = new tag_1.Tag(Object.assign({}, hoverOnLabelAttributes));
        hoverOnLabel.name = constant_1.AXIS_ELEMENT_NAME.title, hoverOnLabel.id = this._getNodeId("hover-on-label"), 
    ...
    getLabelHoverOnAxisAttribute() {
        ...
        if ((0, vutils_1.isNil)(angle) && autoRotate) {
            const axisVector = this.getRelativeVector(), v1 = [ 1, 0 ];
            angle = (0, matrix_1.angleTo)(axisVector, v1, !0);
            const {verticalFactor: verticalFactor = 1} = this.attribute;
            textBaseline = 1 === -1 * verticalFactor ? "bottom" : "top";
        } else {
