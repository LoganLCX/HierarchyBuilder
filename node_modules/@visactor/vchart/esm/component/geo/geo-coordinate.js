...
export class GeoCoordinate extends BaseComponent {
    ...
    initEvent() {
        ...
        if (roam) {
            let zoom = !0, drag = !0, blank = !1;
            !0 !== roam && (zoom = null === (_a = roam.zoom) || void 0 === _a || _a, drag = null === (_b = roam.drag) || void 0 === _b || _b, 
            blank = null !== (_c = roam.blank) && void 0 !== _c && _c), zoom && this.initZoomEventOfRegions(this._regions, null, this._handleChartZoom), 
            drag && this.initDragEventOfRegions(this._regions, blank ? null : () => !0, this.pan), 
