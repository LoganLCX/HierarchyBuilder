...
export class Compiler {
    ...
    runStageAnimation() {
        ...
        if (!this._stateAnimationConfig || animationState === AnimationStateEnum.none) return;
        const animationConfigs = array(this._stateAnimationConfig[animationState]).filter((config => config.type));
        animationConfigs.length && (animationState === AnimationStateEnum.appear ? this._stage.stopAnimationState(AnimationStateEnum.disappear) : animationState === AnimationStateEnum.disappear && this._stage.stopAnimationState(AnimationStateEnum.appear), 
