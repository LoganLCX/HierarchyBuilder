...
export class BaseSeries extends BaseModel {
    ...
    created() {
        ...
        this.initStageAnimation()), this.afterInitMark(), this.initEvent(), this.event.emit(ChartEvent.afterInitEvent, {
            model: this
        });
    }
    ...
    _createExtensionMark(spec, parentMark, namePrefix, index, options) {
        ...
        if (mark) {
            if (isValid(spec.id) && mark.setUserId(spec.id), options.hasAnimation && !1 !== spec.animation) {
            ...
            }))), !isNil(spec.dataId) || !isNil(spec.dataIndex)) {
    ...
    initStageAnimation() {
        ...
        (null == compiler ? void 0 : compiler.setStageAnimationConfig) && compiler.setStageAnimationConfig(animationConfig({}, userAnimationConfig("stage", this._spec, this._markAttributeContext), null));
    }
    initMarkState() {
