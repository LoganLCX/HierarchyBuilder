...
class BaseSeries extends base_model_1.BaseModel {
    ...
    created() {
        ...
        this.initStageAnimation()), this.afterInitMark(), this.initEvent(), this.event.emit(event_1.ChartEvent.afterInitEvent, {
            model: this
        });
    }
    ...
    _createExtensionMark(spec, parentMark, namePrefix, index, options) {
        ...
        if (mark) {
            if ((0, vutils_1.isValid)(spec.id) && mark.setUserId(spec.id), options.hasAnimation && !1 !== spec.animation) {
            ...
            }))), !(0, vutils_1.isNil)(spec.dataId) || !(0, vutils_1.isNil)(spec.dataIndex)) {
    ...
    initStageAnimation() {
        ...
        utils_1.animationConfig)({}, (0, utils_1.userAnimationConfig)("stage", this._spec, this._markAttributeContext), null));
    }
    initMarkState() {
