...
const event_1 = require("./../constant/event"), interface_1 = require("./interface"), env_1 = require("../util/env"), type_1 = require("../util/type"), vutils_1 = require("@visactor/vutils"), vrender_core_1 = require("@visactor/vrender-core"), factory_1 = require("../core/factory"), mark_1 = require("../util/mark"), util_1 = require("./util"), debug_1 = require("../util/debug"), interface_2 = require("../animation/interface");
...
class Compiler {
    ...
    _doRender(immediately) {
        ...
        this._stage && (this.runStageAnimation(), this._rootMarks.forEach((g => {
    ...
    runStageAnimation() {
        var _a;
        const animationState = null === (_a = this._stage.context) || void 0 === _a ? void 0 : _a.animationState;
        if (!this._stateAnimationConfig || animationState === interface_2.AnimationStateEnum.none) return;
        const animationConfigs = (0, vutils_1.array)(this._stateAnimationConfig[animationState]).filter((config => config.type));
        animationConfigs.length && (animationState === interface_2.AnimationStateEnum.appear ? this._stage.stopAnimationState(interface_2.AnimationStateEnum.disappear) : animationState === interface_2.AnimationStateEnum.disappear && this._stage.stopAnimationState(interface_2.AnimationStateEnum.appear), 
