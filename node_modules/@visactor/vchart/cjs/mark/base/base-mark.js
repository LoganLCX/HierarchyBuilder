...
class BaseMark extends grammar_item_1.GrammarItem {
    ...
    getAnimationState() {
        const graphicsAnimationStates = this._graphics.map((g => g.context.animationState)), animationState = graphicsAnimationStates.every((state => state === interface_3.AnimationStateEnum.appear)) ? interface_3.AnimationStateEnum.appear : graphicsAnimationStates.every((state => state === interface_3.AnimationStateEnum.disappear)) ? interface_3.AnimationStateEnum.disappear : graphicsAnimationStates[0];
        return null != animationState ? animationState : interface_3.AnimationStateEnum.none;
    }
