...
let DefaultGraphicUtil = class {
    ...
    constructor(contributions) {
        ...
        this._textMeasureMap = new Map, this.global.hooks.onSetEnv.tap("graphic-util", ((lastEnv, env, global) => {
    ...
    bindTextMeasure(tm) {
        this._textMeasure && "DefaultTextMeasureContribution" !== tm.id || (this._textMeasure = tm), 
        this._textMeasureMap.has(tm.id) || this._textMeasureMap.set(tm.id, tm);
    }
