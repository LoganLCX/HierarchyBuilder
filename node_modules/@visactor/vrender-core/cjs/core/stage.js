...
const vutils_1 = require("@visactor/vutils"), window_1 = require("./window"), event_1 = require("../event"), container_1 = require("../container"), constants_1 = require("../render/constants"), group_1 = require("../graphic/group"), theme_1 = require("../graphic/theme"), constants_2 = require("../picker/constants"), constants_3 = require("../plugins/constants"), auto_render_plugin_1 = require("../plugins/builtin-plugin/auto-render-plugin"), auto_refresh_plugin_1 = require("../plugins/builtin-plugin/auto-refresh-plugin"), incremental_auto_render_plugin_1 = require("../plugins/builtin-plugin/incremental-auto-render-plugin"), dirty_bounds_plugin_1 = require("../plugins/builtin-plugin/dirty-bounds-plugin"), tapable_1 = require("../tapable"), constants_4 = require("./constants"), application_1 = require("../application"), env_check_1 = require("../env-check"), factory_1 = require("../factory"), graphic_1 = require("../graphic"), DefaultConfig = {
    WIDTH: 500,
    HEIGHT: 500,
    X: 0,
    Y: 0,
...
class Stage extends group_1.Group {
    ...
    constructor(params = {}) {
        ...
        this.window = container_1.container.get(window_1.VWindow), this.renderService = container_1.container.get(constants_1.RenderService), 
        this.pluginService = container_1.container.get(constants_3.PluginService), this.layerService = container_1.container.get(constants_4.LayerService), 
    ...
    enableAutoRefresh() {
        this.autoRefresh || "node" === this.global.env || (this.autoRefresh = !0, this.pluginService.register(new auto_refresh_plugin_1.AutoRefreshPlugin));
    }
    disableAutoRefresh() {
    ...
    getPickerService() {
        return this.pickerService || (this.pickerService = container_1.container.get(constants_2.PickerService)), 
        this.pickerService;
    }
    reInit() {
